...
export const PRESETS = {
  "e-piano-fm": {
    ...
    params: { algorithm: ALGORITHM.mod1, index: 0.85,
      ...
      velToIndex: 0.4, reverbMix: 0.3, reverbSize: 0.7, delayMix: 0.18, delayTime: 0.33, gain: 0.58 },
  },
  "warm-keys": {
    ...
    params: { algorithm: ALGORITHM.mod1, index: 0.5,
      ...
      velToIndex: 0.3, reverbMix: 0.35, reverbSize: 0.8, delayMix: 0.2, delayTime: 0.29, gain: 0.45 },
  },
  "bell": {
    ...
    params: { algorithm: ALGORITHM.mod1, index: 1.1,
      ...
      velToIndex: 0.3, reverbMix: 0.45, reverbSize: 0.85, delayMix: 0.3, delayTime: 0.28, gain: 0.62 },
  },
  "glass-bell": {
    ...
    params: { algorithm: ALGORITHM.mod2, index: 0.8,
      ...
      velToIndex: 0.3, reverbMix: 0.5, reverbSize: 0.9, delayMix: 0.25, delayTime: 0.31, gain: 0.37 },
  },
  "breathy-brass": {
    ...
    params: { algorithm: ALGORITHM.mod2, index: 1.0,
      ...
      velToIndex: 0.5, chorusMix: 0.25, chorusRate: 0.5, chorusDepth: 3.5, reverbMix: 0.35, gain: 0.32 },
  },
  "fm-bass": {
    ...
    params: { algorithm: ALGORITHM.mod1, index: 0.7,
      ...
      velToIndex: 0.35, reverbMix: 0.08, reverbSize: 0.4, gain: 0.34 },
  },
  "metal-pluck": {
    ...
    params: { algorithm: ALGORITHM.mod1, index: 1.2,
      ...
      velToIndex: 0.4, reverbMix: 0.2, reverbSize: 0.6, delayMix: 0.15, delayTime: 0.21, gain: 0.8 },
  },
  "fb-pad": {
    ...
    params: { algorithm: ALGORITHM.feedback, index: 0.6, feedback: 0.35,
      ...
      velToIndex: 0.3, chorusMix: 0.3, chorusRate: 0.45, chorusDepth: 4.0, reverbMix: 0.5,
  ...
  "stack-keys": {
    ...
    params: { algorithm: ALGORITHM.stack2, index: 0.7,
      ...
      op3Ratio: 3, op3Level: 0.75, op3Attack: 0.002, op3Decay: 0.6, op3Sustain: 0.2, op3Release: 0.4,
      op4Ratio: 1, op4Level: 0.5, op4Attack: 0.002, op4Decay: 0.7, op4Sustain: 0.1, op4Release: 0.5,
      velToIndex: 0.4, reverbMix: 0.4, reverbSize: 0.75, delayMix: 0.2, delayTime: 0.27, gain: 0.6 },
  },
  "twang": {
    ...
    params: { algorithm: ALGORITHM.mod1, index: 1.0,
      ...
      velToIndex: 0.35, reverbMix: 0.18, delayMix: 0.12, delayTime: 0.19, gain: 0.85 },
  },
};
