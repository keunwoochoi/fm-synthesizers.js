...
export function auditNpmReadme({ version, readme }) {
  ...
  if (!readme.includes("npm install fm-synthesizers.js")) fail("missing the exact npm install command");
  if (!readme.includes("https://www.npmjs.com/package/fm-synthesizers.js")) fail("missing the npm package-page link");
...
export function checkRoot(root) {
  ...
  const logoUrl = `https://raw.githubusercontent.com/keunwoochoi/fm-synthesizers.js/main/${logoPath}`;
