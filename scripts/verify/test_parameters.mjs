...
import { ALGORITHM, PARAM, PARAMETERS, PARAM_DEFAULTS, RATIOS } from "../../packages/core/src/parameters.js";
...
test("metadata owns a complete contiguous worklet ABI", () => {
  ...
  assert.equal(PARAMETERS.algorithm.values, ALGORITHM);
  assert.equal(RATIOS.one, 1);
  assert.ok(Object.keys(RATIOS).length >= 8, "the classic FM ratio set is present");
